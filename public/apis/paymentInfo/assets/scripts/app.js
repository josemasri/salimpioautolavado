...
(function ($) {
	...
	$.fn.paymentInfo.defaults = {
		...
		animationWait: 600,
		focusDelay: 200,
		messageEnterCardNumber : "Por favor ingresa el número de tu tarjeta de crédito", //Please enter your credit card number
		messageCardNumberError : "Por favor ingresa un número válido de tarjeta",//Please enter a valid credit card number
		messageLuhnCheckError : "Por favor revise el número de su tarjeta de crédito", //Please double check your credit card number
		messageExpiration : "Por favor ingresa el mes y año de expiración de tu tarjeta", //Please enter your card's expiration month and year
		messageExpirationError : "Por favor ingresa un mes y año validos", //Please enter a valid month and year
		messageCVV : "Por favor ingresa los 3 digitos de seguridad al reverso de tu tarjeta", //Please enter the three-digit CVV number found on the back of your card
		messageCVVAmEx : "Por favor ingresa los 3 digitos de seguridad de la parte frontal de tu tarjeta", //Please enter your four-digit CVV number on the front of your card
		messageZip : "Por favor ingresa tu C.P.", //Please enter your billing zip code
