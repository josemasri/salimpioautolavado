    ...
    <form id="datosAutmovilForm">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
            <div class="form-group">
                ...
                <input type="number" class="form-control required" name="nivelEstacionamiento" id="automovil-placas" fieldType="string" required-message="Placas requeridas" error-message="Ingrese placas de automóvil válidas">
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-info" style="font-size: .8em; color: white;">
            <strong>En caso de seleccionar lavada por dentro favor de dejar el auto abierto.</strong>
        </div>
    </form>
