...
<p>
    ...
    palmashills.salimpio.com  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
    ...
    palmashills.salimpio.com ofrece la devolución de tu dinero en caso de que el servicio realizado en tu auto no sea de la calidad que prometemos. En caso de que esto suceda favor de mandar evidencias (Fotografías) al correo salimpiocarwash@gmail.com y por este medio nos encargaremos de reponerte el servicio sin costo
    ...
    Este sitio web http://palmashills.salimpio.com garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.

    La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.

    palmashills.salimpio.com reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
</p>
</div>
</body>
<script>
